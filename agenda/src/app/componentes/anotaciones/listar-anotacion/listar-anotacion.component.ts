...
@Component({
  selector: 'app-listar-anotacion',
  templateUrl: './listar-anotacion.component.html',
  styleUrls: ['./listar-anotacion.component.css']
})
export class ListarAnotacionComponent {
  ...
  ngOnInit(): void {
    ...
    this.crudService.ObtenerAnotacionEstudiante(userName).subscribe(respuesta => {
